...
call compile preprocessFileLineNumbers "custom\ZSC\gold\player_traderMenu.sqf";

BIS_fnc_numberDigits = compile preprocessFileLineNumbers "custom\ZSC\compiles\numberDigits.sqf";
BIS_fnc_numberText = compile preprocessFileLineNumbers "custom\ZSC\compiles\numberText.sqf"; 
SC_fnc_removeCoins = compile preprocessFileLineNumbers "custom\ZSC\compiles\SC_fnc_removeCoins.sqf";
SC_fnc_addCoins = compile preprocessFileLineNumbers "custom\ZSC\compiles\SC_fnc_addCoins.sqf";

/*overwrites*/
if( isNil "ZSC_Overwrite_SelfActions" || ZSC_Overwrite_SelfActions)then{
fnc_usec_selfActions = compile preprocessFileLineNumbers "custom\ZSC\compiles\fn_selfActions.sqf";
};
if( isNil "ZSC_Overwrite_SwitchModel" || ZSC_Overwrite_SwitchModel)then{
player_switchModel = compile preprocessFileLineNumbers "custom\ZSC\compiles\player_switchModel.sqf";
};


if( isNil "ZSC_Overwrite_LockVault" || ZSC_Overwrite_LockVault)then{
player_lockVault =			compile preprocessFileLineNumbers "custom\ZSC\compiles\player_lockVault.sqf";
};

if( isNil "ZSC_Overwrite_UnLockVault" || ZSC_Overwrite_UnLockVault)then{
player_unlockVault =			compile preprocessFileLineNumbers "custom\ZSC\compiles\player_unlockVault.sqf";
};
	

player_gearSet	=	compile preprocessFileLineNumbers "custom\ZSC\compiles\player_gearSet.sqf";
